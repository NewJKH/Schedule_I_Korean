...
{
    [BepInPlugin("kr.schedule1.textfixer", "Korean Text Fixer", "1.13.0")]
    public class Plugin : BasePlugin
    {
        public override void Load()
        {
            ...
            try
            {
                ...
                KLog.Info("KoreanTextFixer 1.13.0 (BepInEx) loaded. entries=" + Translations.Dict.Count + " rules=" + Rules.Count);
            }
            catch (Exception e)
            {
