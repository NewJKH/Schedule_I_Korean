...
[assembly: MelonInfo(typeof(KoreanTextFixer.MelonPlugin), "Korean Text Fixer", "1.6.0", "Schedule I 한글패치")]
    ...
    public class MelonPlugin : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            try
            {
                ...
                KLog.Info("KoreanTextFixer 1.6.0 (MelonLoader) loaded. entries=" + Translations.Dict.Count);
            }
            catch (Exception e)
            {
